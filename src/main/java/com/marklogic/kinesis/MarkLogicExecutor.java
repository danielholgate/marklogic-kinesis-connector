...
public class MarkLogicExecutor
  extends KinesisConnectorExecutor<KinesisMessageModel, MarkLogicMessageModel>
{
  ...
  public static void main(String[] args)
  {
    ...
    KinesisConnectorExecutor<KinesisMessageModel, MarkLogicMessageModel> marklogicExecutor = new MarkLogicExecutor("MarkLogicConnector.properties");
    ...
    if (marklogicExecutor.config.MARKLOGIC_TEST_CONNECTION)
    {
      ...
      _client = new MarkLogicJavaClientManager(marklogicExecutor.config.MARKLOGIC_HOST, marklogicExecutor.config.MARKLOGIC_PORT, marklogicExecutor.config.MARKLOGIC_USER, marklogicExecutor.config.MARKLOGIC_PASSWORD);
      _client.open();
